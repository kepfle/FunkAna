...
\newcommand{\docTitel}					{Grundlagen der Funktionalanalysis}			% title of the lecture/book
\newcommand{\docUntertitel}			{Sommersemester 2016}					% subtitle
\newcommand{\docDozent}					{Prof. Dr. B. Jacob}			% name of the professor
\newcommand{\docJahr}						{2016}										% publishing year
\newcommand{\docUniversitaet}		{Bergische Universit\"at Wuppertal}		% name of university
\newcommand{\docTitelZitat}			{Im Zweifel immer das Richtige nehmen.}
\newcommand{\docTitelZitatName}	{Prof. Dr. B. Jacob}				% titlepage quote author
