...
\includeonly{content/hilbertop}											% while writing your book, compile only what you need
...
\include{content/dual}
\include{content/kompakt}
\include{content/hannbanach}
\include{content/reflex}
\include{content/haupt}
\include{content/projekt}
\include{content/hilbert}
\include{content/hilbertop}
